...
export const companyRequirements = [
  {
    id: 0,
    text: 'This company requires profieciency in English language as the Lessons are prepared in English.'
  },
  {
    id: 1,
...
export const companyReviews = [
  {
    ...
    avatar: reviewer1,
    comment:
      'Excellent Company for any beginner like me :p The trainer was very generous and helped whenever DMed.',
    rating: 4.5,
    liked: 230,
    date: '3 days ago'
  },
  ...
  },
  {
    ...
    avatar: reviewer4,
    comment:
      'I was confused about what tool is good for me and this finally company helped me a lot. I’m definitely going to refer it to my peers.',
    rating: 5,
    liked: 68,
    date: '7 days ago'
  },
  {
    ...
    avatar: reviewer5,
    comment:
      'This company changed my life. I changed my profession and now I’m living a happy life where I’m in charge. Thanks to both Bill and Falcon.',
    rating: 3.5,
    liked: 0,
    date: '8 days ago'
  }
...
export const companyLessons = [
  {
    id: 0,
    title: 'Intro',
    excerpt: 'Introduction and Company Objectives',
    isLocked: false,
    attachment: {
      image: intro,
      src: beachVideo,
