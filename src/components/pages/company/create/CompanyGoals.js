  ...
  return (
    <Card className="mb-3 mb-lg-0">
      <Card.Header as="h5" className="bg-light">
        Company Goals and Key features
      </Card.Header>
      <Card.Body>
        <Form.Label htmlFor="companyGoal">
          Company Goals<span className="text-danger">*</span>
        </Form.Label>
        ...
        <Form.Group controlId="companyGoal" className="position-relative mb-4">
          <Form.Control
            type="text"
            name="companyGoal"
            required
