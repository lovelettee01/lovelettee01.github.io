...
const CompanyPreviewVideo = ({ register }) => {
  ...
  return (
    <Card className="mb-3">
      ...
      <Card.Body className="bg-light">
        ...
        <Form.Group controlId="companyYoutubeLink" className="mt-3">
...
CompanyPreviewVideo.propTypes = {
  register: PropTypes.func.isRequired
};

export default CompanyPreviewVideo;
